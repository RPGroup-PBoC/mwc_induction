...
# Save the figure.
plt.savefig('/Users/gchure/Dropbox/mwc_induction/figures/flow_cloud.pdf',
bbox_inches='tight')
...
# plt.savefig('/Users/gchure/Dropbox/mwc_induction/figures/flow_cytometry_distributions.svg')
plt.show()
...
plt.ylim([-0.01, 1.1])
plt.tick_params(labelsize=18)
plt.savefig('/Users/gchure/Dropbox/mwc_induction/figures/example_titration.svg')
