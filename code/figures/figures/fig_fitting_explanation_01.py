...
<<<<<<< HEAD
                yerr=fc_err, linestyle='none',
                color=colors[j], label=None)
            ax.plot(np.sort(data[data.rbs==rbs].IPTG_uM.unique()) / 1E6,
                    fc_mean, marker='o', linestyle='none', markeredgecolor=colors[j], markerfacecolor='w', markeredgewidth=2, label=260)
...
=======
            ...
            ax.plot(np.sort(data[data.rbs==rbs].IPTG_uM.unique()) / 1E6,
                       ...
                       markeredgewidth=1.5, markeredgecolor=colors[j], markerfacecolor='w', 
...
plt.savefig(output + '/fig_fit_explanation_01.png', bbox_inches='tight',
dpi=300)
