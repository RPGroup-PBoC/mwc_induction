...
plt.text(0.7, 0.105, 'leakiness', color='w', backgroundcolor='b', fontsize=12,
...
plt.text(0.43, 0.18, r'$EC_{50}$', color='w', backgroundcolor='c', fontsize=12,
        transform=ax.transAxes)
...
color='w', transform=ax.transAxes, fontsize=12)
...
plt.tight_layout()
plt.savefig('/Users/gchure/Dropbox/mwc_induction/Figures/supplementary_figures/properties.pdf',
bbox_inches='tight')
