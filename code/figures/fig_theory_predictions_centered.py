...
# Change the lables from axis 1 to axis 0
handles, labels = ax[1].get_legend_handles_labels()
ax[0].legend(handles, labels, loc='upper left', title='repressors / cell')
...
plt.tight_layout()
plt.savefig(output + '/fig_predictions_O2_RBS1027_fit_no_data_centered.pdf', 
        bbox_inches='tight')
