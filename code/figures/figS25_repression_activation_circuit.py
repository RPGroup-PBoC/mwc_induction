...
with sns.axes_style('white'):
    ...
    for i in range(4):
        ...
        ax.set_xlabel(r'$\frac{c_R}{K_A^{(R)}}$', labelpad=25, fontsize=30)
        ax.set_ylabel(r'$\frac{c_A}{K_A^{(A)}}$', labelpad=25, fontsize=30)
        ax.set_zlabel(r'fold-change', labelpad=25, fontsize=25)
        ax.set_zlim3d([-2, 2])
        ax.set_xlim3d([-7, 2])
        ax.set_ylim3d([-2, 6])
        ax.set_xticks([-6, -4, -2, 0, 2])
        ax.set_xticklabels(['$10^{-6}$', '$10^{-4}$','$10^{-2}$', '$10^0$', '$10^2$'])
        ax.set_yticks([-2, 0, 2, 4, 6])
        ax.set_yticklabels(['$10^{-2}$', '$10^{-2}$','$10^{0}$', '$10^1$', '$10^2$'])
        ax.set_zticks([-2, -1, 0, 1, 2])
        ax.set_zticklabels(['$10^{-2}$', '$10^{-1}$', '$10^0$', '$10^1$', '$10^2$'])
        ax.view_init(30, 285)
        ax.tick_params(labelsize=20)
        ax.w_xaxis.set_pane_color((0.887, 0.859, 0.816, 1.0))
        ax.w_yaxis.set_pane_color((0.887, 0.859, 0.816, 1.0))
        ax.w_zaxis.set_pane_color((0.887, 0.859, 0.816, 1.0))
        ax.w_zaxis.gridlines.set_color((0, 0, 0, 1.0))
        ax.w_xaxis.gridlines.set_color((0, 0, 0, 1.0))
        ax.w_yaxis.gridlines.set_color((0, 0, 0, 1.0))
        ax.w_xaxis.gridlines.set_lw(5)
        ax.w_yaxis.gridlines.set_lw(5)
        ax.w_zaxis.gridlines.set_lw(5)
        ax.w_xaxis.gridlines.set_linestyle('--', color='w')
        ax.w_yaxis.gridlines.set_linestyle('--', color='w')
        ax.w_zaxis.gridlines.set_linestyle('--', color='w')
        plt.tight_layout()
