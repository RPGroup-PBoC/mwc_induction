...
concentrations = [0, 1, 5, 10, 25, 50, 75, 100, 250, 500, 1000, 5000] # uM IPTG
...
# write
df.to_csv('output/' + str(date) + '_O2_IPTG_titration_MACSQuant.csv', index=False)
#=============================================================================== 
# Add the comments to the header of the data file
filenames = ['./comments.txt', 'output/' + str(date) + '_O2_IPTG_titration_MACSQuant.csv']
with open('../../../data/' + str(date) + '_O2_IPTG_titration_MACSQuant.csv', 'w') as output:
