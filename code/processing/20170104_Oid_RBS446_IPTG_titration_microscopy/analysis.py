...
IPTG_RANGE = [0.1,  5, 10, 25, 50, 75, 100, 250, 500, 1000, 5000]
# Load the data files.
df = pd.read_csv('output/20170104_Oid_IPTG_titration_microscopy.csv')
...
for group, data in fc_grouped:
    ...
    fc_exp.append((rbs_grp['RBS446'] - rbs_grp['auto']) /
