...
\section*{Abstract/Digest}

%% Please keep the abstract below 300 words
%\section*{Abstract}
%
%\talComment{This needs to be done.}
%
...
%\griffinComment{We should emphasize here that this is a general concept. It may be wise not to even mention Lac by name \talComment{I agree. In the digest, we definitely should not mention Lac by name} and just focus on the theory of induction and how it applies to a simple and testable genetic circuit.}
