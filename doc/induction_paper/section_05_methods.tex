...
described in \cite{Garcia2011} \talComment{Let's discuss cite vs citep}. Briefly, the operator mutants and YFP reporter
...
\cite{Aghaeepour2013, Lo2008}. In these methods \talComment{it is a bit hard to understand that ``these methods'' does not refer to our project}, however, the rare events are
