...
binding site mutants were cloned into a pZS3\*5 plasmid backbone (find plasmid nomenclature reference). Expression of
...
\griffinComment{reference the maintext equation here once we converge on
...
perform the final parameter estimation, we should report some of the MCM
