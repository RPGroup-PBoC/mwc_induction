...
\begin{figure}[h]
	\centering \includegraphics[scale=0.4]{simple_states_and_weights_allosteric_independence.pdf}
...
\begin{figure}[h]
	\centering \includegraphics[scale=0.4]{inducer_states_and_weights.pdf}
